...
//   return (
//     <div className="p-6">
//       <h1 className="text-3xl font-bold mb-4">Glimps</h1>
  ...
  <div className="max-w-7xl mx-auto relative z-10 flex flex-col min-h-screen">        {/* Section Header */}
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-3">
            ...
            />
            <Eye className="h-8 w-6 text-[#0a91ab]" />
            <motion.div
       ...
       <h2 className="font-bold mb-4 sm:mb-2 font-mono text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
...
<div className="relative flex-1 flex flex-col md:flex-row justify-center gap-6">
          {/* Main Display */}
  <motion.div
    className="relative w-full md:w-3/4 h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] 
