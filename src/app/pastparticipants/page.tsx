...
export default function ParticipantsSection() {
  ...
  return (
    <section className="min-h-screen py-20 px-6 relative overflow-hidden bg-[#022333]">
      {/* Background Grid */}
      <div className="min-h-screen absolute inset-0 opacity-10">
        <motion.div
          ...
          style={{
            backgroundImage: `
              linear-gradient(90deg, #0a91ab 0.5px, transparent 1px),
              linear-gradient(0deg, #ffc045 0.5px, transparent 3px)
            `,
